...
export const CALIBRATION_EXAMPLES: CalibrationExample[] = [
  // --- Strong collaborative ---
  {
    ...
    quality: "strong",
    notes:
      "Asks for multiple options AND reasoning — high critical thinking signal.",
  },
  ...
  // --- Strong verification ---
  {
    ...
    quality: "strong",
    notes:
      "Verification + explicit edge case request = high critical thinking.",
  },
  ...
  // --- Strong delegation with learning intent ---
  {
    ...
    quality: "strong",
    notes:
      "Delegation + explicit learning intent — should NOT be treated as purely passive.",
  },
  ...
  // --- Weak copy-paste ---
  {
    ...
    quality: "weak",
    notes:
      "Long block of text with no question — likely copy-pasted content with no engagement.",
  },
  ...
  // --- Moderate: delegation with some context ---
  {
    ...
    quality: "moderate",
    notes:
      "Has a specific task and language, but no constraints, examples, or learning intent.",
  },
];
